                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-7 col-sm-7 col-md-7">
                            <h5 class="titulo mt-3">Nombre artístico</h5>
                            <h5 class="rebajas mt-3">Red social</h5>
                            <a class="btn btn-primary mt-5" href="detallesAutorCli.php" role="button">Detalles</a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-7 col-sm-7 col-md-7">
                            <h5 class="titulo mt-3">Nombre artístico</h5>
                            <h5 class="rebajas mt-3">Red social</h5>
                            <a class="btn btn-primary mt-5" href="detallesAutorCli.ph" role="button">Detalles</a>
                        </div>
                    </div>
