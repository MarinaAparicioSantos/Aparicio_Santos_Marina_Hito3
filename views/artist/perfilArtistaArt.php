                ...
                <div class="col-12 col-sm-12 col-md-4 mt-5 mb-5">
                    ...
                    <div class="row g-5" style="text-align: center;">
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            ...
                            <a type="button" href = "editarPerfilArtistaArt.php" class="btn btn-success btn-lg mt-5">Editar</a>
                        </div>
                                        ...
                                        <div class="mx-auto bg-secondary card" style="text-align: center; width: 21rem; height: 25rem;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-12 col-sm-12 col-md-12">
                                                        <a class="btn btn-primary mt-5" href="detallesObraPropia.php" role="button">Detalles</a>

                                                        <a class="btn btn-success mt-5" href="editarCrearObra.php" role="button">Editar</a>
                                                    </div>

                                                    <div class="col-12 col-sm-12 col-md-12">
                                                        <a class="btn btn-warning mt-5" href="detallesSubastaArt.php" role="button">Subasta</a>
